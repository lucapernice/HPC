# 0 "read_write_pgm_image.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "read_write_pgm_image.c"
...
# 5 "read_write_pgm_image.c" 2
# 32 "read_write_pgm_image.c"
...

{
  ...
  *image = 
# 95 "read_write_pgm_image.c" 3 4
          ((void *)0)
# 95 "read_write_pgm_image.c"
              ;
  *xsize = *ysize = *maxval = 0;

  char MagicN[2];
  char *line = 
# 99 "read_write_pgm_image.c" 3 4
                ((void *)0)
# 99 "read_write_pgm_image.c"
                    ;
  size_t k, n = 0;
 ...
 fscanf(image_file, "%d%*c", maxval);
  ...
  if ( (*image = (char*)malloc( size )) == 
# 128 "read_write_pgm_image.c" 3 4
                                          ((void *)0) 
# 128 "read_write_pgm_image.c"
                                               )
    {
      fclose(image_file);
      *maxval = -2;
  ...
  if ( fread( *image, 1, size, image_file) != size )
    {
      free( image );
      image = 
# 140 "read_write_pgm_image.c" 3 4
               ((void *)0)
# 140 "read_write_pgm_image.c"
                   ;
      *maxval = -3;
      *xsize = 0;
      *ysize = 0;
...

{
  if ( maxval > 255 )
   ...
   ((unsigned short int*)image)[i] = (( (((unsigned short int*)image)[i]) & (short int)0xff00) >> 8) + ( ((((unsigned short int*)image)[i]) & (short int)0x00ff) << 8);
    }
  return;
}
      ...
      for ( int yy = 0; yy < ysize; yy++ )
 {
   ...
   for( int xx = 0; xx < xsize; xx++ )
...

    {
      ...
      unsigned short int _maxval = (( ((unsigned short int)maxval) & (short int)0xff00) >> 8) + ( (((unsigned short int)maxval) & (short int)0x00ff) << 8);
      int idx = 0;
      for ( int yy = 0; yy < ysize; yy++ )
 {
   unsigned short int value = (short int) (minval+ yy*delta);
   unsigned short int _value = (( (value) & (short int)0xff00) >> 8) + ( ((value) & (short int)0x00ff) << 8);
...
# 244 "read_write_pgm_image.c" 3 4
                                                         1234
# 244 "read_write_pgm_image.c"
